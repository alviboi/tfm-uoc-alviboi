...
<div class="container">
	...
	<canvas id="canvas" width='140' height='190' hidden
	...
	<form id="actualitzar">
		...
		<div class="col-lg-12 superior">
			...
			<div class="col-lg-11 superior">
				...
				<div class="row text-left block-left">
					...
					<fieldset class="form-group col-lg-2">
						<label for="Poblacio">Població</label> <input type="text"
					...
					<fieldset class="form-group col-lg-1">
						<label for="CodiPostal">CP</label> <input type="text"
							class="form-control input-sm" id="CP" name="CP" placeholder="Codi Postal"
							required="required">
					</fieldset>
				...
				<div class="row">
					...
					<fieldset class="form-group col-lg-2">
						<label for="DNI">DNI (sense guió)</label> <input type="text"
							...
							placeholder="DNI, NIE o Pasaport" required="required" maxlength="9">
					</fieldset>

					<fieldset class="form-group col-lg-2">
						<label for="Tlf">Telèfon de contacte</label> <input type="text"
							class="form-control" id="Telefon" name="Telefon"
							placeholder="Telèfon de contacte" required="required" maxlength="9">
					</fieldset>
			...
			<div class="col-lg-1">
				...
				<img class="img_2" onclick="obrir_dialog()" id="foto" width="100"
					height="150"
					style="border: 2px solid gray; text-align: center; color: red;"
					value="Imatge" alt="Polsa per a prendre imatge" />
		...
		<div class="row" >
			...
			<fieldset class="form-group col-lg-3">
				<label for="Provincia de naixement">Província de naixement</label> <input
					type="text" class="form-control" id="ProvinciaNaixement"
		...
		<div class="text-center row" style = "border-bottom: solid rgba(0, 255, 0, 0.2); margin-top: 10px;"><b>Selecciona primer els curs i després si está matriculat</b></div>
		<div class="row" style = "margin-top: 10px">
			...
			<fieldset class="form-group col-lg-3">
				...
				<input type="checkbox" name="Matriculat[]" id="MatriculatProgramaACicleI" value="" onClick="copiavalor('ProgramaACicleI')"> <span title="Matricula'l si no passa per sorteig">Matriculat</span>
				</div>
			</fieldset>
			<fieldset class="form-group col-lg-3">
				...
				<div class="text-center">
				<input type="checkbox" name="Matriculat[]" id="MatriculatProgramaBcicleII" value="" onClick="copiavalor('ProgramaBcicleII')"> <span title="Matricula'l si no passa per sorteig">Matriculat</span>
				</div>
			</fieldset>
			<fieldset class="form-group col-lg-3">
		...
		<div class="row">
			<div>
				...
				<fieldset class="form-group col-lg-3">
					...
					<div class="text-center">
				<input type="checkbox" name="Matriculat[]" id="MatriculatProgramaCValenciaJQCV" value="" onClick="copiavalor('ProgramaCValenciaJQCV')"> <span title="Matricula'l si no passa per sorteig">Matriculat</span>
				</div>
				</fieldset>
				...
				<fieldset class="form-group col-lg-3">
					...
					<div class="text-center">
				<input type="checkbox" name="Matriculat[]" id="MatriculatProgramaBDCursosPolivalents" value="" onClick="copiavalor('ProgramaBDCursosPolivalents')"> <span title="Matricula'l si no passa per sorteig">Matriculat</span>
				</div>
				</fieldset>
				<fieldset class="form-group col-lg-3">
					...
					<div class="text-center">
				<input type="checkbox" name="Matriculat[]" id="MatriculatProgramaJAnglesBasic" value="" onClick="copiavalor('ProgramaJAnglesBasic')"> <span title="Matricula'l si no passa per sorteig">Matriculat</span>
				</div>
				</fieldset>
			</div>
			<div>
		...
		<div class="row col-lg-12">
			<div class="text-center">
				<fieldset class="form-group col-lg-12">
					<input type="checkbox" name="Validada" id="Validada" title="Es valida l'alumne quan ha entregat tota la documentació"> <span title="Es valida l'alumne quan ha entregat tota la documentació">Valida l'alumne</span>
		...
		<div class="row text-center">
			<span class="btn btn-primary btn-success"
				onCLick="actualitza_dades()" id="envia" title="Actualitzaràs les dades i s'obrirà una finestra nova amb el full de matrícula">Desa</span>
			<span title="Esborres completament l'alumne de la base de dades" class="btn btn-primary btn-danger" onClick="esborra_alumne()"
				id="esborra">Esborra</span> <span class="btn btn-primary"
				onClick="full_matricula_alumne()" id="esborra">Full de matricula</span>
			<span title="Importes alumnes d'anys anteriors. Però només les dades personals." class="btn btn-primary" onClick="importa_alumne()" id="esborra">Importa
				alumne</span>
