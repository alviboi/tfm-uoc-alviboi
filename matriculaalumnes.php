...
<div class="row">
				...
				<fieldset class="form-group col-lg-3">
			  	...
			  	<fieldset class="form-group col-lg-3" onClick="comprova(ProgramaBcicleII.value)" id="ProgramaBcicleII2">
...
<div class="row text-center">
				    <button class="btn btn-primary btn-success" onCLick="inscriu_alumne()" id="envia">Matricula't</button> 			 		
</div>
